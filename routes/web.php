...
Route::get('console/education/list', [StudiesController::class, 'list'])->middleware('auth');
Route::get('/console/education/add', [StudiesController::class, 'addEducation'])->middleware('auth');
Route::post('/console/education/add', [StudiesController::class, 'add'])->middleware('auth');
Route::get('/console/education/edit/{study:id}', [StudiesController::class, 'editEducation'])->where('study', '[0-9]+')->middleware('auth');
Route::post('/console/education/edit/{study:id}', [StudiesController::class, 'edit'])->where('study', '[0-9]+')->middleware('auth');
Route::get('/console/education/delete/{study:id}', [StudiesController::class, 'delete'])->where('study', '[0-9]+')->middleware('auth');
