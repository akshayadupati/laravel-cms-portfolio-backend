...
<section class="w3-padding">
    ...
    <form method="post" action="/console/works/add" novalidate class="w3-margin-bottom">
        ...
        <div class="w3-margin-bottom">
            ...
            <input type="number" min="1900" max="2099" step="1" value="2010" name="start_from" id="start_from" value="{{old('start_from')}}" required />
        ...
        <div class="w3-margin-bottom">
            ...
            <input type="number" min="1900" max="2099" step="1" value="2016" name="end_to" id="end_to" value="{{old('end_to')}}"  />
        ...
        <button type="submit" class="w3-button w3-green">Add Work</button>
